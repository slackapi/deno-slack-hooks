...
export const VERSIONS = {
  [DENO_SLACK_BUILDER]: "0.0.10",
  [DENO_SLACK_RUNTIME]: "0.0.6",
  [DENO_SLACK_HOOKS]: "0.0.6",
};

export const BUILDER_TAG = `${DENO_SLACK_BUILDER}@${VERSIONS[DENO_SLACK_BUILDER]}`;
export const RUNTIME_TAG = `${DENO_SLACK_RUNTIME}@${VERSIONS[DENO_SLACK_RUNTIME]}`;
