...
import { assert, assertEquals, assertSpyCall, stub } from "../dev_deps.ts";

let mkdirStub = stub(Deno, "mkdir");
let writeTextFileStub = stub(Deno, "writeTextFile");
...
const validOutputOne: string = `/** This file was autogenerated on ${
